...
public class Calculator implements ActionListener {
    ...
    JButton addButton, subButton, mulButton, divButton, darButton;
    JButton decButton, equButton, delButton, negButton,clrButton;
    JPanel panel;
    
    
    Font myFont= new Font("Comic Sans",Font.ITALIC,30 );
    ...
    Calculator(){
        ...
        for(int i =0; i<10;i++){
         ...
         darButton.setBounds(150,490,80,50);
